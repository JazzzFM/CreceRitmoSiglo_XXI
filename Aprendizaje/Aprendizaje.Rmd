...
En este curso vamos a revisar los procesos básicos de la percepción, la atención y la memoria según las investigaciones y cómo aplican en la práctica. Si la ciencia apoya la efectividad de cierta estrategia de aprendizaje, la debemos adoptar, 
Al mismo tiempo debemos seguir siendo flexibles, por qué la ciencia sigue evolucionando.

¿Tú te pondrías la vacuna aunque no haya sido probada? o peor aún ¿si científicamente está comprobado que no funciona?

```{r stormtrooper, fig.margin = TRUE, echo = FALSE, fig.width=3, out.width = "100%", fig.align="center"}
