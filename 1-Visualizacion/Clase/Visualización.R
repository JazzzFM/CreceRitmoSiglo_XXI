...
# Clase 1: Primeros pasos y mapeos estéticos ----------------------------------------------------------
...
# Clase 3: Transformación estadística ----------------------------------------------
diamonds
?diamonds
...
# esta variablo no existe en la base de datos de dónde viene?
...
# Clase 4:  Ajuste de posición  y Coordenadas ----------------------------------------------
